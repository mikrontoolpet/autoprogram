...
class Tool(BaseTool):
    ...
    async def set_parameters(self):
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute Length", front_fl_len)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 1 (Output)/dL End", 1.2*self.diam)
        # Feeds and speeds
        ...
        # Flute 101 (G2)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 101/Rake Shift", 0.0185*self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 101/dL Start", front_dl_start)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 101/dL End", 0.8*self.diam)
        # Feeds and speeds
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 201/Cutting Speed", s_g1_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 201/Feedrate", s_g1_feedrate)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 1/Straight Gash/Profile 2D/sR", 0.0649*self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 1/Straight Gash/Profile 2D/sL", 0.55*self.diam)
        # Feeds and speeds
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 1/Straight Gash/Cutting Speed", s1_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 1/Straight Gash/Feedrate In", s1_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 1/Straight Gash/Feed along sweep+exit", s1_feedrate)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 101/Straight Gash/Profile 2D/sR", 0.0649*self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 101/Straight Gash/Profile 2D/sL", 0.0786*self.diam)
        # Feeds and speeds
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 101/Straight Gash/Cutting Speed", tn3_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 101/Straight Gash/Feedrate In", tn3_feedrate_in)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 201/Straight Gash/Cutting Speed", tn1_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 201/Straight Gash/Feedrate In", tn1_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 201/Straight Gash/Feed along sweep+exit", tn1_feedrate)
        ...
        # Step 0 OD Clearance
        # OD Clearance 1 (F1)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Step 0 Diameter/Step 0 OD Clearance/OD Clearance 1/Margin Width", 0.0757*self.diam)
        # Feeds and speeds
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Step 0 Diameter/Step 0 OD Clearance/OD Clearance 1/Cutting Speed", f1_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Step 0 Diameter/Step 0 OD Clearance/OD Clearance 1/Feedrate", f1_feedrate)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Step 0 Diameter/Step 0 OD Clearance/OD Clearance 101/Cutting Speed", f2_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Step 0 Diameter/Step 0 OD Clearance/OD Clearance 101/Feedrate", f2_feedrate)

        # Set 2
        # Profile
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Profile/D0", self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Profile/sP1", self.diam)

        # Flute 1
        back_fl_len = self.fl_len - front_fl_len
        back_infeed_down_y = 0.375*self.diam + 0.3 # flute depth + security distance
        # await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Index", -4)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Custom Profile Flute/dZ", -front_fl_len)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Custom Profile Flute/D", self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Custom Profile Flute/L", back_fl_len)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 1 (Output)/dL End", -0.25*self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 1 (Output)/Infeed Down Y", back_infeed_down_y)
        # Feeds and speeds
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 1 (Output)/Cutting Speed", g3_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 1 (Output)/Feedrate In", g3_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 1 (Output)/Feedrate", g3_feedrate)

        # Flute 101 (S_G3)
        s_g3_att_ang = self.configuration_wb.trend("function_data", "diameter", self.diam, "S_G3_attack_angle")
        s_g3_dl_start = g3_dl_start
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/Rake Shift", rs)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/dL End", -0.17*self.diam)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/Infeed Down Y", back_infeed_down_y)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/Exit Radius", 0.333*self.diam)
        # Feeds and speeds
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/Cutting Speed", s_g3_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/Feedrate In", s_g3_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 101/Feedrate", s_g3_feedrate)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 201/Cutting Speed", rn12_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 201/Feedrate In", rn12_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 201/Feedrate", rn12_feedrate)
        ...
        # Feeds and speeds
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 301/Cutting Speed", rn12_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 301/Feedrate In", rn12_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 301/Feedrate", rn12_feedrate)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 3/Rake Operations/Gash 1/Cutting Speed", tn2_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 3/Rake Operations/Gash 1/Feedrate In", tn2_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 3/Rake Operations/Gash 1/Feed along sweep+exit", tn2_feedrate)
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 3/Reliefs/Relief Section 1/Relief 1/Cutting Speed", sm_speed)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 3/Reliefs/Relief Section 1/Relief 1/Feedrate In", sm_feedrate_in)
        await self.vgpc.set("ns=2;s=tool/Tool/Set 3/Reliefs/Relief Section 1/Relief 1/Feedrate", sm_feedrate)
    ...
    async def set_wheels(self):
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 1/Straight Gash/Wheel", op_wh_seg)
        # TN1
        op_wh_seg = self.configuration_wb.lookup("gashes", "diameter", self.diam, "TN1_wheel")
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 201/Straight Gash/Wheel", op_wh_seg)
        # TN2
        ...
        await self.vgpc.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Gash 101/Straight Gash/Wheel", op_wh_seg)
        # P1
