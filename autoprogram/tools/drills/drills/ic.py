...
class Tool(BaseTool):
    ...
    def set_parameters(self):
        ...
        # self.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Index", -4)
        ...
        # self.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 201/Infeed Down Y", 0.2*self.diam)
        # Feeds and speeds
        ...
        self.set("ns=2;s=tool/Tool/Set 2/Common Data/Flutes/Flute 1/Flute 301/Infeed Down Y", 0.15*self.diam)
        # Feeds and speeds
