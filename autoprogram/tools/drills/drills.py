...
class Titanium(Tool):
    ...
    async def set_parameters(self):
        ...
        f_wh_width = float(WorkBook("V:/Common/MTI_Production-Engineering-Team/VGPro_Master_Programs/drills/drills/Titanium/configuration_file.xlsx").lookup("whp_4", "diam", self.diam, "f_wh_width"))
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 1 (Output)/Circular Land Width", circ_land_width)
        # # Flute 101 (SGR. G1)
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 101/Rake Shift", -fl_rad_stk_rmv)
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 101/Circular Land Width", circ_land_width + 2*fl_rad_stk_rmv)
        # #Flute 1001 (G2)
        ...
        # # Step 0 OD Clearance
        # # OD Clearance 1 (F1)
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Step 0 Diameter/Step 0 OD Clearance/OD Clearance 1/Margin Width", marg_width_1)
    ...
    async def set_wheels(self):
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1/Flute 101/Wheel", op_wh_seg)
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Wheel", op_wh_seg)
        # # SS
        # op_wh_seg = WorkBook("V:/Common/MTI_Production-Engineering-Team/VGPro_Master_Programs/drills/drills/Titanium/configuration_file.xlsx").lookup("wheels", "diam", self.diam, "TN1")
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Gash/Wheel", op_wh_seg)
        # # P1
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Point Relief/Relief 1/Point Relief 1/Wheel", op_wh_seg)
        # # P2
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Point Relief/Relief 1/Point Relief 2/Wheel", op_wh_seg)
        # # S_P2
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Step 0 (Point)/Point Relief/Relief 101/Point Relief 102/Wheel", op_wh_seg)
        ...
        # whp_path = Path(config.STD_WHP_BASE_DIR).joinpath(whp_name + config.WHP_SUFFIX)
        # await self.vgp.load_wheel(whp_path, 4)
        ...
        # whp_path = Path(config.STD_WHP_BASE_DIR).joinpath(whp_name + config.WHP_SUFFIX)
        # await self.vgp.load_wheel(whp_path, 6)
        ...
        # await self.vgp.set("ns=2;s=tool/Tool/Set 1/Common Data/Flutes/Flute 1001/Wheel", op_wh_seg)